      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-[1fr,auto] gap-12">
          ...
          <div className="hidden xl:block">
            <div className="bg-card/50 backdrop-blur-sm border border-card-border rounded-md p-4 w-48">
              <p className="text-xs text-muted-foreground mb-2 text-center">Advertisement</p>
              <div className="h-[600px] bg-muted/20 rounded flex items-center justify-center">
                <span className="text-sm text-muted-foreground rotate-90 whitespace-nowrap">
