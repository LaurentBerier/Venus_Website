  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Every part affects weight, balance, movement, and stability. Build bigger, but make sure your fortress can actually survive the terrain.',
        },
        {
          title: 'Survive on the Move',
          description: 'Cross acid plains, glass deserts, storms, ruins, and unstable ground while keeping your machine alive and your crew breathing.',
        },
        {
          title: 'Mine, Refine, Upgrade',
          description: 'Cut into Venusian rock, gather minerals, unlock blueprints, and build more powerful systems to push deeper into the planet.',
        },
        {
          title: 'Defend Your Machine',
          description: 'At sunrise, abandoned solar-powered machines wake up and hunt your energy. Fight them off, scavenge their remains, or keep moving.',
        },
        {
          title: 'Discover Lost Ruins',
          description: 'Explore pre-war industrial outposts to find blueprints, logs, clues, and the remains of earlier attempts to survive Venus.',
        },
      ],
    },
    world: {
      title: 'Explore Venus',
      subtitle: 'A Hostile World Awaits',
      locations: [
        {
          name: 'Acid Plains',
        ...
        {
          name: 'Glass Deserts',
          description: 'Crystallized silica wastelands shaped by ancient volcanic heat, hiding mineral deposits and the wreckage of earlier expeditions.',
        },
        {
          name: 'Cloud City',
    ...
    editions: {
      ...
      standard: {
        ...
        price: 'Free',
        items: [
          'Core rolling fortress gameplay',
      ...
      deluxe: {
        ...
        price: 'TBD',
        items: [
          'Complete rolling fortress campaign',
          'Full Venusian world to explore',
          'Dozens of buildable modules',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'Venus: The Last Ascent is developed by Breaking Walls, an independent game studio based in Montreal, Canada, focused on atmospheric worlds, systemic gameplay, and ambitious player-driven experiences.',
        },
      ],
    },
    contact: {
      ...
      sentDescription: 'Thanks for reaching out. We will get back to you soon.',
      errorTitle: 'Message not sent',
      errorDescription: 'Please try again or email info@breakingwalls.co directly.',
      press: 'Press Kit',
      downloadPress: 'Access Press Kit',
    },
    footer: {
      legal: 'Legal',
      privacy: 'Privacy Policy',
      terms: 'Terms of Service',
      copyright: '\u00A9 2026 Breaking Walls. All Rights Reserved.',
    },
  },
  fr: {
    nav: {
      ...
      preOrder: 'Ajouter en Liste de Souhaits',
    },
    hero: {
      title: 'Venus: The Last Ascent',
    ...
    features: {
      ...
      items: [
        ...
        {
          title: 'Survivre en Mouvement',
          description: 'Traversez des plaines acides, des d\u00E9serts de verre, des temp\u00EAtes et des ruines tout en maintenant votre machine en vie.',
        },
        {
          title: 'Miner, Raffiner, Am\u00E9liorer',
          description: 'Creusez dans la roche v\u00E9nusienne, r\u00E9coltez des min\u00E9raux, d\u00E9bloquez des plans et construisez des syst\u00E8mes plus puissants.',
        },
        {
        ...
        },
        {
          ...
          description: 'Explorez des avant-postes industriels perdus pour trouver des plans, des journaux et les restes des tentatives pr\u00E9c\u00E9dentes de survivre sur V\u00E9nus.',
        },
      ],
    },
    world: {
      title: 'Explorez V\u00E9nus',
      subtitle: 'Un Monde Hostile',
      locations: [
        {
          name: 'Plaines Acides',
    ...
    editions: {
      ...
      subtitle: 'Disponible sur Steam',
      standard: {
        name: 'D\u00E9mo Disponible',
        price: 'Gratuit',
        items: [
          'Gameplay forteresse roulante',
          'Syst\u00E8mes de construction physique',
      ...
      deluxe: {
        ...
        price: '\u00C0 d\u00E9terminer',
        items: [
          'Campagne forteresse roulante compl\u00E8te',
          'Monde v\u00E9nusien entier \u00E0 explorer',
          'Dizaines de modules constructibles',
      ...
      collectors: {
        ...
        price: '15 juin 2026',
        items: [
          'En vedette au Steam Next Fest',
          'Acc\u00E8s d\u00E9mo \u00E9tendu',
          'Diffusions en direct et Q&R',
          'Nouvelle bande-annonce le 2 juin 2026',
          'Ajoutez en liste pour \u00EAtre notifi\u00E9',
          'Rejoignez la communaut\u00E9 Breaking Walls',
        ],
      },
    },
    media: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Venus: The Last Ascent est d\u00E9velopp\u00E9 par Breaking Walls, un studio de jeu ind\u00E9pendant bas\u00E9 \u00E0 Montr\u00E9al, Canada.",
        },
      ],
    },
    contact: {
      ...
      sentDescription: 'Merci de nous avoir contact\u00E9s. Nous vous r\u00E9pondrons bient\u00F4t.',
      errorTitle: 'Message non envoy\u00E9',
      errorDescription: 'Veuillez r\u00E9essayer ou \u00E9crire directement \u00E0 info@breakingwalls.co.',
      press: 'Kit Presse',
      downloadPress: 'Acc\u00E9der au Kit Presse',
    },
    footer: {
      legal: 'L\u00E9gal',
      privacy: 'Politique de Confidentialit\u00E9',
      terms: "Conditions d'Utilisation",
      copyright: '\u00A9 2026 Breaking Walls. Tous Droits R\u00E9serv\u00E9s.',
    },
  },
};
